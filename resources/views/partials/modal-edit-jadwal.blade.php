<!-- Modal -->
<div class="modal fade slide-up disable-scroll" id="modalEditJadwal" tabindex="-1" role="dialog"
    aria-labelledby="modalEditJadwalLabel" aria-hidden="false" wire:ignore.self>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group form-group-default">
                                    ...
                                    <input type="number" name="id_jadwal" id="id_jadwal" wire:model='id_jadwal'
