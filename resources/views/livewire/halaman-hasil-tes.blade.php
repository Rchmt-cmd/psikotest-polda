<div class="row full-height no-margin">
  @include('partials.modal-konfirmasi-reset-hasil-tes')
    ...
    <div class="full-height p-2">
      <div class="card card-default p-1">
        ...
        <div class="card-header">
          <div class="pull-left">
            <div class="col-xs-12">
              <h3 class="bold fs-16 no-margin font-montserrat">Total peserta yang menyelesaikan tes: <span
                  class="light fs-16 no-margin">{{ $dataHasilTesPesertas->count() }} Orang</span></h3>
            </div>
          </div>
          <div class="pull-right">
            <div class="col-xs-12">
              <button class="btn btn-danger" data-toggle="modal" data-target="#modalKonfirmasiResetHasilTes"><i
                  class="pg-icon">danger</i>Reset Data Hasil Tes</button>
              <button class="btn btn-primary" wire:click="handleEksportData()"><span class="material-icons fs-16">
                  print
                </span>Eksport Data</button>
            </div>
          </div>
        </div>
          ...
          <table id="tableHasilTes" class="table table-hover" cellspacing="0" width="100%"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="fs-12">{{ date('d F Y', strtotime($dataHasilTes->tanggal_tes)) }}, {{
                  $dataHasilTes->waktu_mulai_akses }} WITA</td>
                ...
                {{-- <td>
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="card-settings">
                      <li><a href="#" data-toggle="modal" data-target="#modalEditSoal"><span
                            class="material-icons fs-16">edit</span>
                          Edit</a></li>
                    </ul>
                  </div>
                </td> --}}
